//
//  changegroupiconViewController.m
//  YH项目
//
...
@interface changegroupiconViewController ()<UIImagePickerControllerDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UITextViewDelegate>
{
    //下拉菜单
...
@implementation changegroupiconViewController
...
- (void)viewDidLoad {
    ...
    _isSubmitted = NO;
    self.navigationItem.title = @"群组头像";
    ...
    [iconView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://%@",self.avatarurl]] placeholderImage:[UIImage imageNamed:@"defaulticon"]];
...
-(void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if ([type isEqualToString:@"public.image"])
    {
        ...
        NSString * urlStr = @"http://zhujinchi.com/index.php/Mobile/Team/uploadAvatar";
