...
- (void)setupToolbars
{
    ...
    [saveButton setContentEdgeInsets:UIEdgeInsetsZero];
    [saveButton.titleLabel setBackgroundColor:[UIColor blackColor]];
...
////    [self addSubview:tempView];
    ...
    //设置运动时间
    animation.duration = SDPhotoBrowserHideImageAnimationDuration;
    //设置运动type
    animation.type = kCATransitionPush;
    animation.subtype = kCATransitionFromLeft;
    [[window layer] addAnimation:animation forKey:@"photoOut"];
    [self removeFromSuperview];
    [[window layer] removeAnimationForKey:@"photoOut"];
}
...
- (void)layoutSubviews{
    ...
    _scrollView.bounds = CGRectMake(rect.origin.x, rect.origin.y+64, rect.size.width, rect.size.height-128);
    ...
    _indexLabel.frame = CGRectMake(0, 20, self.frame.size.width, 44);
    _saveButton.frame = CGRectMake(0, self.frame.size.height, self.frame.size.width, -64);
}
...
- (void)show{
    ...
    CATransition *animation = [CATransition animation];
    //设置运动时间
    animation.duration = SDPhotoBrowserShowImageAnimationDuration;
    //设置运动type
    animation.type = kCATransitionPush;
    animation.subtype = kCATransitionFromRight;
    [[window layer] addAnimation:animation forKey:@"photoIn"];
    [window addSubview:self];
    [[window layer] removeAnimationForKey:@"photoIn"];
}
