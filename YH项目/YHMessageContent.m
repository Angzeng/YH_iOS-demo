...
@implementation YHMessageContent

+(instancetype)messageWithContent:(NSString *)content {
    YHMessageContent *msg = [[YHMessageContent alloc] init];
    if (msg) {
        msg.content = content;
    }
    NSString *sourceString = [[msg valueForKey:@"content"] valueForKey:@"sourceUserId"];
    NSLog(@"%@",sourceString);
