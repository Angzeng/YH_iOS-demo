...
@implementation YHInfoPopView

-(id)initWithFrame:(CGRect)frame{
    CGFloat widthScale = 0.82;
    CGFloat heightScale = 0.78;
    self = [super initWithFrame:CGRectMake(frame.size.width*(1-widthScale)/2, frame.size.height*(1-heightScale)/2, frame.size.width*widthScale, frame.size.height*heightScale)];
    if (self) {
        ...
        [f_btn setFrame:CGRectMake(0, self.frame.size.height, self.frame.size.width/2, -(self.frame.size.height*0.12>44?44:self.frame.size.height*0.12))];
