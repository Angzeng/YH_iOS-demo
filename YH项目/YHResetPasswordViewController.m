//
//  YHResetPasswordViewController.m
//  YH项目
//
...
@interface YHResetPasswordViewController ()
...
@implementation YHResetPasswordViewController
...
- (void) submit{
    ...
    NSLog(@"%@,%@",_sessionId,_getIdentifyingCode);
    NSDictionary *parameters = @{@"type":@"2",@"mobile":_getAccount,@"password":_getPassword1,@"sessionid":_sessionId,@"phonecode":_getIdentifyingCode};
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    //设置回复内容信息
    [manager.requestSerializer setValue:YHjwt forHTTPHeaderField:@"Authorization"];
    manager.responseSerializer.acceptableContentTypes = [manager.responseSerializer.acceptableContentTypes setByAddingObject:@"text/html"];
