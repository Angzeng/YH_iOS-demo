...
@interface YHInfoPopViewController ()

@property(nonatomic,strong) YHInfoPopViewItems *items;
@property(nonatomic,strong) YHInfoPopView *popView;
...
@implementation YHInfoPopViewController
...
- (void)viewDidLoad {
    ...
    _popView = [[YHInfoPopView alloc] initWithFrame:self.view.frame];
...
-(void) chat{
    ...
    [[self.InfoPopViewHandlerDelegate getNavigationController] pushViewController:YC animated:YES];
