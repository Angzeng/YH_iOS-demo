...
@interface YHgroupListTableViewController ()
...
@implementation YHgroupListTableViewController
...
- (void)getgrouplist {
    NSString * urlStr = @"http://zhujinchi.com/index.php/Mobile/TeamUser/getTeamList";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cellimageview sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://%@",[[_CellsItems objectAtIndex:indexPath.row] objectForKey:@"tavatar"]]] placeholderImage:[UIImage imageNamed:@"defaulticon"]];
    [cell.contentView addSubview:cellimageview];
    //setname
    UILabel *celltargettitle = [[UILabel alloc] initWithFrame:CGRectMake(66, 10, 200, 23)];
    celltargettitle.text = [[_CellsItems objectAtIndex:indexPath.row] objectForKey:@"tname"];
    ...
    _celltargetid = [[_CellsItems objectAtIndex:indexPath.row] objectForKey:@"tid"];
    NSLog(@"%ld%@",(long)indexPath.row,_celltargetid);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    YHConversationTargetId = [[_CellsItems objectAtIndex:indexPath.row] objectForKey:@"tid"];
    YHConversationTitle = [[_CellsItems objectAtIndex:indexPath.row] objectForKey:@"tname"];
    [[NSNotificationCenter defaultCenter]postNotificationName:@"loadgroup" object:self];
